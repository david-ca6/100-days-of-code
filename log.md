...
### Day 02: Jan 05 2023    
**Today's Progress**   
Today I wrote C code to display a debug overlay when debug mode is enabled in the game i'm working on as a personal project. 
**Thoughts**   
Should probably a git repo for the code...
**Link(s) to work**  
TODO...
...
### Day 05: Jan 08 2023   
**Today's Progress**  
Today I wrote C code to create a custom text imput field in ui of the game I'm working on as a personal project. 
**Thoughts**   
**Link(s) to work**  
**Link(s) to reference used**  
...
### Day 14: Jan 17 2023   
**Today's Progress**  
Today I worked on debugging firmware written in C on a product I maintain. I also wrote a script to automate the setup of my fedora workstation with all the software, extensions, and settings I use.
**Thoughts**   
**Link(s) to work**  
**Link(s) to reference used**  
